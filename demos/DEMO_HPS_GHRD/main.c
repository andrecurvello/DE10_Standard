...
#define ALT_FPGA_LED_INTFC ( ( unsigned long )( ALT_LWFPGASLVS_OFST + LED_PIO_BASE ) & ( unsigned long)( HW_REGS_MASK ) )
#define ALT_FPGA_7SEG_INTFC ( ( unsigned long )( ALT_LWFPGASLVS_OFST + TERASIC_SEG7_0_BASE ) & ( unsigned long)( HW_REGS_MASK ) )
    ...
    if( -1  != fd )
    {
        ...
        */
        ...
        if( MAP_FAILED != virtual_base )
        {
            ...
            pvHps2FpgaLed = virtual_base + ALT_FPGA_LED_INTFC;
