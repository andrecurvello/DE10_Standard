...
# ----------------------------------------
# If avlm_avls_1x1 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 17.0 595 win32 2017.10.09.17:09:53
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "C:/intelfpga_pro/17.0/quartus/quartus/"
}
...
ensure_lib                           ./libraries/slave_0/                  
vmap       slave_0                   ./libraries/slave_0/                  
...
alias com {
  ...
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_avalon_mm_master_bfm_vhdl.vhd"                                     -work master_0         

  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_mm_slave_bfm.sv"              -L altera_common_sv_packages -work slave_0                 
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_mm_slave_bfm_vhdl_wrapper.sv" -L altera_common_sv_packages -work slave_0                 
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_avalon_mm_slave_bfm_vhdl_pkg.vhd"                                 -work slave_0                 
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L altera_common_sv_packages -L slave_0 -L master_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}
