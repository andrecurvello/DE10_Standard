...
add_fileset_file SEG7.vhd VHDL PATH SEG7.vhd TOP_LEVEL_FILE
...
add_interface_port slave slvReadDataOut readdata Output 8
add_interface_port slave slvWriteDataIn writedata Input 8
add_interface_port slave slWriteStrobeIn write Input 1
