...
add_fileset_file TERASIC_SEG7.vhd VHDL PATH TERASIC_SEG7.vhd TOP_LEVEL_FILE
...
add_interface_port clock_sink slClkIn clk Input 1
...
add_interface_port reset_sink slReset reset Input 1
...
add_interface_port slave slvAddressIn address Input ADDR_WIDTH
add_interface_port slave slReadStrobeIn read Input 1
add_interface_port slave slvReadDataOut readdata Output 32
add_interface_port slave slvWriteStrobeIn write Input 1
add_interface_port slave slvWriteDataIn writedata Input 32
